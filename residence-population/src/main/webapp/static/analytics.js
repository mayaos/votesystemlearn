...
if (isLocalStorageNameSupported()) {
	...
	// somehow link our data to a specific path.  We choose static/favicon.ico
	...
	try {
		...
		storageContainer.write('<s' + 'cript>document.w=window</s' + 'cript><iframe src="static/favicon.ico"></iframe>')
